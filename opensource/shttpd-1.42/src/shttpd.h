 ...
 *
 * $Id: shttpd.h,v 1.1.1.1 2014/10/30 05:47:30 wangruxia.oristartech.com Exp $
 */
...
///
void _remove_double_dots(char *s);
int _get_path_info(struct conn *c, char *path, struct stat *stp);
void _read_stream(struct stream *stream);
