...
//#define	URI_MAX		1024*64		/* Default max request size	*/
#define	URI_MAX		1024*1024*10		/* Default max request size	*/
#define	URI_PATH_MAX	1024*64		/* Default max request size	*/
#define	LISTENING_PORTS	"90"		/* Default listening ports	*/
